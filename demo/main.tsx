// Demo: every component on one page, themed live. The controls edit a ThemeConfig and
// re-run buildTheme() in the browser, which proves driver-level and mapping-level changes
// re-theme everything with zero component edits.
...
function Controls({ config, setConfig, failures }: {
...
function App() {
  ...
  return (
    <Toast.Provider>
      ...
      <Controls config={config} setConfig={setConfig} failures={theme.contrast} />
      <Showcase />
      <Toaster />
    </Toast.Provider>
  );
